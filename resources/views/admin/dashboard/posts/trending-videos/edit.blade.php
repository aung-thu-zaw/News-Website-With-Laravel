    ...
    <div class="row">
        <div class="col-12 p-5">
            ...
            <form action="{{ route('admin.trending-videos.update',$trendingVideo->id) }}" method="POST"
                ...
                <x-form.input type="text" name="video_id" value="{{ $trendingVideo->video_id }}">
                    <x-form.label name="Video Id *" />
                </x-form.input>

                <x-form.input type="text" name="owner" value="{{ $trendingVideo->owner }}">
                    <x-form.label name="Owner *" />
                </x-form.input>

                <x-form.textarea name="caption" value="{{ $trendingVideo->caption }}">
