    ...
    <div class="row">
        <div class="col-12 px-5 pt-5 pb-3">
            ...
            <x-form.admin-search-form>
                <a href="{{ route('editor.photo-gallery.create') }}" class="btn btn-primary text-decoration-none">Create
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <form action="{{ route('editor.photo-gallery.edit',$photo->id) }}" method="GET">
                                    @csrf
                                ...
                                <form action="{{ route('editor.photo-gallery.destroy',$photo->id) }}" method="POST">
                                    @csrf
                                    @method("DELETE")
                                    <input type="hidden" name="page" value="{{ $photos->currentPage() }}">
