    ...
    <div class="row">
        <div class="col-12 px-5 pt-5 pb-3">
            ...
            <x-form.admin-search-form>
                <a href="{{ route('editor.video-news-posts.create') }}"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class=" d-flex align-items-center">
                                <form action="{{ route('editor.video-news-posts.edit',$post->slug) }}" method="GET">
                                    @csrf
                                ...
                                <form action="{{ route('editor.video-news-posts.destroy',$post->slug) }}" method="POST">
                                    @csrf
                                    @method("DELETE")
                                    <input type="hidden" name="page" value="{{ $videoNewsPosts->currentPage() }}">
