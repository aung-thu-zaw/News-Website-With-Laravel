    ...
    <div class="row">
        <div class="col-12 px-5 pt-5 pb-3">
            ...
            <x-form.admin-search-form>
                <a href="{{ route('editor.categories.create') }}" class="btn btn-primary text-decoration-none">Create
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <form action="{{ route('editor.categories.edit',$category->slug) }}" method="GET">
                                    @csrf
                                ...
                                <form action="{{ route('editor.categories.destroy',$category->slug) }}" method="POST">
                                    @csrf
                                    @method("DELETE")
                                    <input type="hidden" name="page" value="{{ $categories->currentPage() }}">
