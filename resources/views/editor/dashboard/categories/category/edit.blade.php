    ...
    <div class="row">
        <div class="col-12 p-5">
            <div class="mb-3 d-flex align-items-center justify-content-end">
                <a href="{{ route('editor.categories.index') }}" class="btn btn-primary text-decoration-none">View <i
                        class="fa-solid fa-eye"></i></a>
            </div>
            <form action="{{ route('editor.categories.update',$category->slug) }}" method="POST" class="border p-5">
                @csrf
                @method("PATCH")
