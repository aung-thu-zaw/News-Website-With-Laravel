    ...
    <div class="row">
        ...
        <div class="col-12 p-5">
            <div class="mb-3 d-flex align-items-center justify-content-end">
                <a href="{{ route('writer.video-news-posts.index') }}" class="btn btn-primary text-decoration-none">View
                    <i class="fa-solid fa-eye"></i></a>
            </div>
            <div class="border p-5">
                <form action="{{ route('writer.video-news-posts.update',$videoNewsPost->slug) }}" method="POST"
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <form action="/writer/video-news-post/{{ $videoNewsPost->slug }}/{{ $tag->slug }}"
                            method="POST">
                            @csrf
