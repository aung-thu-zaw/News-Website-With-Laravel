    ...
    <div class="row">
        <div class="col-12 px-5 pt-5 pb-3">
            ...
            <x-form.admin-search-form>
                <a href="{{ route('writer.news-posts.create') }}" class="btn btn-primary text-decoration-none">Create
                    ...
                    <tr>
                        ...
                        <td>
                            <div class=" d-flex align-items-center">
                                ...
                                <form action="{{ route('writer.news-posts.edit',$post->slug) }}" method="GET">
                                    @csrf
                                ...
                                <form action="{{ route('writer.news-posts.destroy',$post->slug) }}" method="POST">
                                    @csrf
                                    @method("DELETE")
